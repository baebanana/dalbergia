...
urlpatterns = [
    ...
    path('genus_delete/<int:genu_id>/', views.genusdelete, name='genusde'),
    ...
    path('species_delete/<int:spec_id>/', views.deletespecies, name='speciesdelete'),
    ...
    path('info_delete/<int:k_id>/', views.deleteinfomation, name='knowdelete'),
